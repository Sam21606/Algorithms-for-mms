...
def main() -> None:
    ...
    while not onGoal:
        currentNodes = []
        currentNodes, followPath, pathNode  = getCurrentNodes(currentNode, direction, v0, pathToNode)
...
def getCurrentNodes(currentNode: Helper.Node, direction: int, v0 : int, pathToThisNode : List[Helper.Node]):
    ...
    return calculateCostForCurrentNodes(v0, direction, openNodes, currentNode), followPath, pathNode
